    ...
    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    <a target="_blank" href="/admin/../documentation/index.html" aria-expanded="false"
                ...
                <li class="menu">
                    <a target="_blank" href="/admin/../documentation/changelog.html" aria-expanded="false"
                       class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                 fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="widget widget-wallet-one">
                            ...
                            <ul class="list-group list-group-media">
                                <li class="list-group-item ">
                                    <div class="media">
                                        <div class="me-3">
                                            <img alt="avatar" src="/admin/src/assets/img/netflix.svg"
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="/admin/src/assets/img/profile-13.jpeg" alt="avatar"><span>Luke Ivory</span>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="/admin/src/assets/img/profile-7.jpeg" alt="avatar"><span>Andy King</span>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="/admin/src/assets/img/profile-10.jpeg" alt="avatar"><span>Laurie Fox</span>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="/admin/src/assets/img/profile-5.jpeg" alt="avatar"><span>Ryan Collins</span>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="/admin/src/assets/img/profile-4.jpeg" alt="avatar"><span>Irene Collins</span>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content customer-name"><img
                                                        src="/admin/src/assets/img/profile-11.jpeg" alt="avatar"><span>Sonia Shaw</span>
                                                </div>
                                            </td>
                                            <td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-scroll">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="/admin/src/assets/img/product-headphones.jpg"
                                                        alt="product">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="/admin/src/assets/img/product-shoes.jpg" alt="product">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="/admin/src/assets/img/product-watch.jpg" alt="product">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="/admin/src/assets/img/product-laptop.jpg" alt="product">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="td-content product-name"><img
                                                        src="/admin/src/assets/img/product-camera.jpg" alt="product">
