        ...
        <div class="widget-content widget-content-area">
            <form wire:submit="submit(Object.fromEntries(new FormData($event.target)))">
                <div class="form-group mb-4">
                    <label for="formGroupExampleInput">نام اسلاید</label>
                ...
                <div class="form-group mb-4">
                    <label for="formGroupExampleInput">فایل اسلاید</label>
                    <input type="file" class="form-control" id="formGroupExampleInput" wire:model="image" name="image" >
                    @error('image')
                    <div wire:loading.remove class="alert alert-light-danger alert-dismissible fade show border-0 mb-4 mt-2" role="alert">
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><svg> ... </svg></button>
                        <strong>خطا!</strong>{{$message}}</button>
                ...
                <div class="form-group mb-4">
                    <label for="formGroupExampleInput">لینک</label>
                    <input type="text" class="form-control" id="formGroupExampleInput" wire:model="link" name="link" >
                    @error('link')
                    <div wire:loading.remove class="alert alert-light-danger alert-dismissible fade show border-0 mb-4 mt-2" role="alert">
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><svg> ... </svg></button>
                        <strong>خطا!</strong>{{$message}}</button>
