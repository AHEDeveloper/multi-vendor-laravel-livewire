<div class="widget-content widget-content-area ecommerce-create-section mt-2">
    <div class="col-md-12">
        ...
        <div class="field-wrapper" x-data="{ isUploading: false, progress: 0 }"
            ...
            <input class="form-control"  type="file" wire:model="photos" multiple checked>
        ...
        <div class="d-flex flex-wrap">
                ...
                @if (in_array($photo->getMimeType(), ['image/jpeg', 'image/png', 'image/jpg', 'image/gif', 'image/webp']))
                    <div class="item w-25 m-2 ">
                        <img src="{{$photo->temporaryURL()}}" class="w-75 rounded">
                        <div class="d-flex justify-content-between align-items-center mt-2 bg-dark p-2 rounded w-75">
                            <div class="form-check form-check-primary form-check-inline">
                                <input type="radio" id="cover-image" {{$index == $coverImage ? 'checked' : ''}} wire:click="setCoverImage({{$index}})" class="form-check-input" name="cover-image">
...
@if (@$product->images)
    <div class="widget-content widget-content-area ecommerce-create-section mt-4">
        <div class="row">
            <div class="col-md-12">
                <label for="product-images"> گالری تصاویر</label>
                <div class="d-flex flex-wrap">
                        ...
                        <div class="item  m-2 ">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-2 bg-dark p-2 rounded">
                                ...
                                <div class="form-check form-check-primary form-check-inline">
                                    ...
                                    <input type="radio" id="cover-image" {{$photo->is_cover == true ? 'checked' : ''}}
                                    wire:click="setOldCoverImage({{$photo->id}},{{$product->id}})" class="form-check-input" name="cover-image">
                                ...
                                <a
                                    ...
                                    href="javascript:0" class="action-btn text-danger btn-delete bs-tooltip">
