            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="mt-0">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="ShopName">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group mb-3">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                <textarea name="" id="" cols="3" rows="3" class="form-control" placeholder="Address"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group mb-3">
                                <textarea name="" id="" cols="3" rows="3" class="form-control" placeholder="description"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
