...
<div>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 d-flex justify-content-sm-start justify-content-center">
                            <div class="dataTables_length" id="blog-list_length">
                                <label>Results:<select name="blog-list_length" wire:model.live="result" aria-controls="blog-list" class="form-control">
                            ...
                            <button type="button"
                                    class="btn btn-success mb-2 me-4 mt-1 ms-2 _effect--ripple waves-effect waves-light"
                        ...
                        <div class="col-12 col-sm-6 d-flex justify-content-sm-end justify-content-center mt-sm-0 mt-3">
                            <div id="blog-list_filter" class="dataTables_filter"><label>
                                    ...
                                    <input type="search" class="form-control" wire:model.live="search" placeholder="سرچ با ایمیل" aria-controls="blog-list"></label>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check form-check-primary">
                                                <h6>{{$loop->iteration + $admins->firstItem() -1}}</h6>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="media">
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns">
                                                <a href="javascript:void(0);" class="action-btn btn-delete bs-tooltip"
                                                   ...
                                                   wire:confirm="شما از حذف ادمین مطمعن هستید؟"
    ...
    <div class="modal fade inputForm-modal" id="inputFormModal" tabindex="-1" role="dialog" wire:ignore.self
         aria-labelledby="inputFormModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                @include('livewire.admin.admin-user.creat')
            </div>
        </div>
    </div>
</div>
