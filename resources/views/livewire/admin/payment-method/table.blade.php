<div id="tableCustomBasic" class="col-lg-8 col-12 layout-spacing">
    <div class="statbox widget box box-shadow">
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>جدل مدیریت درگاه</h4>
                </div>
            </div>
        </div>
        <div class="widget-content widget-content-area">
            ...
            <div class="table-responsive">
                    ...
                    @foreach($payments as $payment)
                        <tr>
                            <td>
                                <div class="media">
                                    <div class="media-body align-self-center">
                                        <h6 class="mb-0">{{$loop->iteration + $payments->firstItem() -1}}</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="media">
                                    <div class="media-body align-self-center">
                                        <h6 class="mb-0">{{$payment->price}}</h6>
                                    </div>
                                </div>
                            </td>
                ...
                {{$payments->links('layouts.admin.pagination')}}
            </div>
